  ...
  programs.yazi = {
    theme = {
      manager = {
        ...
        hovered = { fg = "black"; bg = "green"; bold = true; };
      ...
      status = {
        ...
        mode_normal = { fg = "black"; bg = "white"; bold = true; };
...
# TODO - dokończ config
# https://github.com/fufexan/dotfiles/tree/5483d2e91882f8dfa2e033dfc07e064e5c656acb/home/terminal/programs/yazi/theme
    };
  };
}
